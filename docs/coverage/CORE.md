...
- Mapped suites: 33
- Mapped Rust files: 315
- Active test blocks: 2933
- Ignored/manual test blocks: 133
- Declared test blocks: 3066
- Weighted coverage points: 2409.0
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| windows | 30 | 2805 | 128 | 2350.2 | 21 | 11 | 100% |
| macos | 30 | 2856 | 108 | 2360.1 | 22 | 11 | 100% |
| linux | 26 | 2499 | 102 | 2072.6 | 20 | 11 | 100% |

## Crate Summary

| Crate | Suites | Integration files | Source unit files | Active tests | Ignored tests | Weighted points | Flows |
| --- | --- | --- | --- | --- | --- | --- | --- |
| screenpipe-engine | 11 | 19 | 104 | 1420 | 42 | 1089.9 | 10 |
...
| configuration | 3 suites / 163 active / 3 ignored / 143.0 pts | 3 suites / 163 active / 3 ignored / 143.0 pts | 3 suites / 163 active / 3 ignored / 143.0 pts |
...
| engine-lifecycle | 6 suites / 206 active / 1 ignored / 181.3 pts | 6 suites / 206 active / 1 ignored / 181.3 pts | 5 suites / 200 active / 1 ignored / 179.6 pts |
...
| performance | 13 suites / 1323 active / 67 ignored / 1170.2 pts | 14 suites / 1418 active / 70 ignored / 1208.2 pts | 13 suites / 1323 active / 67 ignored / 1170.2 pts |
...
| privacy | 6 suites / 888 active / 36 ignored / 719.1 pts | 6 suites / 935 active / 16 ignored / 723.5 pts | 6 suites / 864 active / 14 ignored / 697.3 pts |
...
| storage | 4 suites / 477 active / 29 ignored / 384.3 pts | 4 suites / 477 active / 29 ignored / 384.3 pts | 4 suites / 477 active / 29 ignored / 384.3 pts |
| sync | 2 suites / 481 active / 3 ignored / 336.7 pts | 2 suites / 481 active / 3 ignored / 336.7 pts | 2 suites / 481 active / 3 ignored / 336.7 pts |
...
| engine-config-lifecycle | screenpipe-engine | windows, macos, linux | configuration, engine-lifecycle, performance | settings-to-engine-config, engine-health-lifecycle, performance-liveness | high | strong | mixed | 11 | 113 | 1 | Fast logic coverage for the config bridge, tray health debounce, sleep/power policies, and queue backpressure. |
...
| engine-redacted-export | screenpipe-engine | windows, macos, linux | privacy, storage, sync, configuration | privacy-and-redaction | high | partial | mixed | 5 | 26 | 0 | Daily batch export of captured activity as PII-redacted JSONL, run under an OS scheduler rather than inside the capture engine. Covers work-hours and denylist filtering, day bucketing, and the cursor advancing past skipped frames. Redaction is exercised through the deterministic regex-only builder, so the ONNX text-PII path used in production is not covered here — hence partial. mod.rs, cursor_state.rs and the bin entrypoint are driven only via tests/export_pipeline.rs and are omitted because the manifest rejects files carrying no test blocks of their own. |
...
| engine-redacted-export | screenpipe-engine | src/export/bucket.rs | source | 3 | 0 | 3 |
| engine-redacted-export | screenpipe-engine | src/export/config.rs | source | 5 | 0 | 5 |
| engine-redacted-export | screenpipe-engine | src/export/filters.rs | source | 11 | 0 | 11 |
| engine-redacted-export | screenpipe-engine | src/export/record.rs | source | 5 | 0 | 5 |
...
| engine-config-lifecycle | screenpipe-engine | src/schedule_monitor.rs | source | 10 | 0 | 10 |
...
| engine-redacted-export | screenpipe-engine | tests/export_pipeline.rs | integration | 2 | 0 | 2 |
